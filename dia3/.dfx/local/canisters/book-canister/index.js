...
import { idlFactory } from './book-canister.did.js';
export { idlFactory } from './book-canister.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.BOOK-CANISTER_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./book-canister.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the book-canister canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./book-canister.did.js")._SERVICE>}
 */
export const book-canister = createActor(canisterId);
