...
import { idlFactory } from './challenge-canister.did.js';
export { idlFactory } from './challenge-canister.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CHALLENGE-CANISTER_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./challenge-canister.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the challenge-canister canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./challenge-canister.did.js")._SERVICE>}
 */
export const challenge-canister = createActor(canisterId);
